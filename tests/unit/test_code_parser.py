...
def test_parse_many():
    ...
    items = [
        RawItem(item_id="a.py", source_type="GIT", title="a.py", content="class A: pass", content_type="python"),
        RawItem(item_id="b.py", source_type="GIT", title="b.py", content="def foo(): pass", content_type="python"),
    ]
